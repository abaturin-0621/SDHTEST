...
@allure.title("Запрос на обновление shipment с корректными параметрами")
...
@allure.description(""" 
    Запрос на обновление shipment с некорректным headers
...
@allure.title("Запрос на обновление shipment с некорректным headers")
...
@allure.testcase("https://cdp.colvir.ru/wiki/display/SDH/A000002", 'A000002')
@allure.description("""
    Запрос на обновление shipment с некорректным endpoint 
...
@allure.title("Запрос на обновление shipment с  некорректным endpoint ")
...
@allure.testcase("https://cdp.colvir.ru/wiki/display/SDH/A000002", 'A000002')
@allure.description("""
    Запрос на обновление shipment с некорректным body
...
@allure.title("Запрос на обновление shipment с некорректными параметрами body")
...
@allure.title("Запрос на обновление shipment с корректными параметрами, проверка схемы ответа")
