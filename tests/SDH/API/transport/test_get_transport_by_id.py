...
@allure.title("Запрос на получение transport с корректными параметрами")
...
@allure.description(""" 
    Запрос на получение transport с некорректным headers
...
@allure.title("Запрос на получение transport с некорректным headers")
...
@allure.testcase("https://cdp.colvir.ru/wiki/display/SDH/A000002", 'A000002')
@allure.description("""
    Запрос на получение transport с некорректным endpoint 
...
@allure.title("Запрос на получение transport с  некорректным endpoint ")
...
@allure.title("Запрос на получение transport с корректными параметрами, проверка схемы ответа")
