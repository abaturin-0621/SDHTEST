...
@allure.title("Запрос на удаление transport с корректными параметрами")
...
@allure.description(""" 
    Запрос на удаление transport с некорректным headers
...
@allure.title("Запрос на удаление transport с некорректным headers")
...
@allure.testcase("https://cdp.colvir.ru/wiki/display/SDH/A000002", 'A000002')
@allure.description("""
    Запрос на удаление transport с некорректным endpoint 
...
@allure.title("Запрос на удаление transport с  некорректным endpoint ")
