...
@allure.feature('schedule get by id')
...
@allure.description(""" 
    Запрос на получение schedule с некорректным headers
...
@allure.title("Запрос на получение schedule с некорректным headers")
...
@allure.testcase("https://cdp.colvir.ru/wiki/display/SDH/A000002", 'A000002')
@allure.description("""
    Запрос на получение schedule с некорректным endpoint 
...
@allure.title("Запрос на получение schedule с  некорректным endpoint ")
...
@allure.testcase("https://cdp.colvir.ru/wiki/display/SDH/A000002", 'A000002')
@allure.description("""
     Запрос на получение schedule с корректными параметрами 
     Ожидаемый результат: схема ответа соответсвует описанию """)
@parametrize("headers",[valid_headers]) 
@parametrize("endpoints",[valid_endpoint]) 
@parametrize("status_code",[RESPONSE_SUCCESS]) 
@parametrize("response_schema",[valid_response_schema]) 
@allure.title("Запрос на получение schedule с корректными параметрами, проверка схемы ответа")
