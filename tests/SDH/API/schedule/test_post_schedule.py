...
@allure.title("Запрос на cоздание schedule с корректными параметрами")
...
@allure.description(""" 
    Запрос на cоздание schedule с некорректным headers
...
@allure.title("Запрос на cоздание schedule с некорректным headers")
...
@allure.testcase("https://cdp.colvir.ru/wiki/display/SDH/A000002", 'A000002')
@allure.description("""
    Запрос на cоздание schedule с некорректным body
    Ожидаемый результат: response.status_code=400
    """)
@parametrize("headers",[valid_headers]) 
@parametrize("body",[no_valid_body]) 
@parametrize("status_code",[RESPONSE_BAD_REQUEST]) 
@allure.title("Запрос на cоздание schedule с некорректными параметрами body")
...
@allure.title("Запрос на cоздание schedule с корректными параметрами, проверка схемы ответа")
