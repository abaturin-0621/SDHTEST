...
@allure.description(""" 
    Запрос на обновление schedule с некорректным headers
...
@allure.testcase("https://cdp.colvir.ru/wiki/display/SDH/A000002", 'A000002')
@allure.description("""
    Запрос на обновление schedule с некорректным endpoint 
...
@allure.title("Запрос на обновление schedule с  некорректным endpoint ")
