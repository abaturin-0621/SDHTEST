...
@allure.title("Запрос на удаление route с корректными параметрами")
...
@allure.description(""" 
    Запрос на удаление route с некорректным headers
...
@allure.title("Запрос на удаление route с некорректным headers")
...
@allure.testcase("https://cdp.colvir.ru/wiki/display/SDH/A000002", 'A000002')
@allure.description("""
    Запрос на удаление route с некорректным endpoint 
...
@allure.title("Запрос на удаление route с  некорректным endpoint ")
