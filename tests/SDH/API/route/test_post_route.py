...
@allure.title("Запрос на cоздание route с корректными параметрами")
...
@allure.title("Запрос на cоздание route с некорректным headers")
...
@allure.title("Запрос на cоздание route с некорректными параметрами body")
...
@allure.title("Запрос на cоздание route с корректными параметрами, проверка схемы ответа")
