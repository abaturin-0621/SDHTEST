...
# @parametrize("schedule",[VALID_OPTIONAL,VALID_NUMBER_INT,None,EXISTS_SHEDULE_ID])
# @parametrize("shipment",[VALID_OPTIONAL,VALID_NUMBER_INT,None,EXISTS_SHIPMENT_ID])
@parametrize("route",[NO_EXISTS_ROUTE_ID,VALID_STRING(256)])
@parametrize("schedule",[NO_EXISTS_SHEDULE_ID,VALID_STRING(256)])
@parametrize("shipment",[NO_EXISTS_SHIPMENT_ID,VALID_STRING(256)])
...
@allure.feature('delivery put by id')
...
@allure.title("Запрос на обновление delivery с корректными параметрами")
...
@allure.description(""" 
    Запрос на обновление delivery с некорректным headers
...
@allure.title("Запрос на обновление delivery с некорректным headers")
...
@allure.testcase("https://cdp.colvir.ru/wiki/display/SDH/A000002", 'A000002')
@allure.description("""
    Запрос на обновление delivery с некорректным endpoint 
...
@allure.title("Запрос на обновление delivery с  некорректным endpoint ")
...
@allure.testcase("https://cdp.colvir.ru/wiki/display/SDH/A000002", 'A000002')
@allure.description("""
    Запрос на обновление delivery с некорректным body
...
@allure.title("Запрос на обновление delivery с некорректными параметрами body")
...
@allure.title("Запрос на обновление delivery с корректными параметрами, проверка схемы ответа")
