...
@allure.title("Запрос на получение delivery с корректными параметрами")
...
@allure.description(""" 
    Запрос на получение delivery с некорректным headers
...
@allure.title("Запрос на получение delivery с некорректным headers")
...
@allure.testcase("https://cdp.colvir.ru/wiki/display/SDH/A000002", 'A000002')
@allure.description("""
    Запрос на получение delivery с некорректным endpoint 
...
@allure.title("Запрос на получение delivery с  некорректным endpoint ")
...
@allure.title("Запрос на получение delivery с корректными параметрами, проверка схемы ответа")
