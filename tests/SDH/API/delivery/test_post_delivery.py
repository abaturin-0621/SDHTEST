...
@allure.title("Запрос на создание delivery с корректными параметрами")
...
@allure.title("Запрос на создание delivery с некорректным headers")
...
# @allure.feature('delivery')
# @allure.suite("check path")
# @allure.story('negative')    
# @allure.story('response 404') 
# @allure.testcase("https://cdp.colvir.ru/wiki/display/SDH/A000002", 'A000002')
# @allure.description("""
#     Запрос на обновление delivery с некорректным path 
...
# def test_invalid_path(headers,endpoints,body,status_code):
#     id=endpoints["id"]
#     url=f"{URL}/{PATH}/{id}/"
...
@allure.title("Запрос на создание delivery с некорректными параметрами body")
